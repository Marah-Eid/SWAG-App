  ...
  const categories = [
    {
      id: 1,
      title: 'Car Rental',
      subtitle: 'Manage rental fleet and bookings',
      route: '/commonScreensV/AfterCarRentalV',
      icon: <Ionicons name="car-sport" size={24} color="#8A1C27" />
    },
    {
      id: 2,
      title: 'Agencies',
      subtitle: 'Manage agency details and inventory',
      route: '/commonScreensV/AfterAgenciesV',
      icon: <Ionicons name="business" size={22} color="#8A1C27" />
    },
    {
      id: 3,
      title: 'Dealerships',
      subtitle: 'Manage showroom and listings',
      route: '/commonScreensV/AfterDealershipsV',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.listContainer}>
          <Text style={styles.sectionLabel}>Auto Services</Text>
...
export default AutoHubVenScreen;