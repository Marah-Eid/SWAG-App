  ...
  const categories = [
    {
      id: 1,
      title: 'Maintenance',
      subtitle: 'Mechanical and electrical logs',
      route: '/commonScreensV/AfterMaintenanceV',
      icon: <Ionicons name="build-outline" size={22} color="#8A1C27" />
    },
    {
      id: 2,
      title: 'Car Washes',
      subtitle: 'Detailing and cleaning services',
      route: '/commonScreensV/AfterCarWashesV',
      icon: <MaterialCommunityIcons name="car-wash" size={24} color="#8A1C27" />
    },
    {
      id: 3,
      title: 'Gas Stations',
      subtitle: 'Fuel, oil, and station management',
      route: '/commonScreensV/AfterGasStationV',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.listContainer}>
          <Text style={styles.sectionLabel}>Essential Services</Text>
...
export default ServicesVenScreen;