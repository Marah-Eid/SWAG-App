...
export default function ChatsVenScreen() {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.footerWrapper}><BottomTabsVen /></View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  listPadding: { paddingBottom: 130, paddingTop: 10 },
  ...
  messageText: { fontSize: 14, color: '#718096' },
