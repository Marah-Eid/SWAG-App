...
const CustomizationScreen = () => {
  ...
  // State to control the menu popup
  ...
  const categories = [
    {
      title: "Tuning",
      subtitle: "Mechanical & Cosmetic mods",
      route: "/commonScreens/AfterTuning",
      icon: <MaterialCommunityIcons name="engine-outline" size={24} color="#8A1C27" />
    },
    {
      title: "Accessories & Add-ons",
      subtitle: "Car gadgets, lights, and more",
      route: "/commonScreens/AfterAccessories",
      icon: <Ionicons name="construct-outline" size={22} color="#8A1C27" />
    },
    {
      title: "Paint & Bodywork",
      subtitle: "Full restoration & detailing",
      route: "/commonScreens/AfterPaint&Bodywork",
      icon: <MaterialCommunityIcons name="format-paint" size={24} color="#8A1C27" />
    },
    {
      title: "Seat Upholstery",
      subtitle: "Custom leather & interior work",
      route: "/commonScreens/AfterSeatUpholstery",
      icon: <FontAwesome5 name="couch" size={20} color="#8A1C27" />
    }
  ];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.listContainer}>
          <Text style={styles.sectionTitle}>Customization Hub</Text>
...
const styles = StyleSheet.create({
  ...
  // Separated wrapper for shadows so the gradient doesn't clip
  navCardWrapper: {
    marginBottom: 15,
  ...
  navCard: {
    ...
    borderRadius: 20,
    overflow: 'hidden', // Keeps gradient inside the curves
  },
  navContent: {
    flexDirection: 'row',
    alignItems: 'center',
