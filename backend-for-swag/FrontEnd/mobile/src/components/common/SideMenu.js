        ...
        <Modal transparent={true} visible={visible} onRequestClose={onClose} animationType="none">
            <View style={styles.overlay}>
                ...
                <Animated.View style={[styles.menuContainer, { transform: [{ translateX: slideAnim }] }]}>
                    <LinearGradient
                        colors={['#FFFFFF', '#DDE5F0', '#AFC6D8']} // UI Polish: Matched App Backgrounds
                    ...
                    >
                        ...
                        <View style={styles.menuList}>
                            <MenuItem
                                ...
                                onPress={() => { onClose(); router.push('/customer/ProfileCust'); }}
                            />
                                ...
                                <View style={styles.subMenuContainer}>
                                    ...
                                    <View style={{ flex: 1 }}>
                                        <SubMenuItem
                                            ...
                                            onPress={() => { onClose(); router.push('/commonScreens/Likes'); }}
                                        />
                                        <SubMenuItem
                                            label="Comments"
                                            iconName="chatbubble-outline"
                                            onPress={() => { onClose(); router.push('/commonScreens/Comments'); }}
                                        />
                                    </View>
                                </View>
                            )}
                            ...
                            <MenuItem
                                ...
                                onPress={() => { onClose(); router.push('/commonScreens/SavedPosts'); }}
                            />

                            <MenuItem
                                label="Settings"
                                icon={require('../../../assets/images/settings-png.png')}
                                onPress={() => { onClose(); router.push('/commonScreens/Settings'); }}
                            />
