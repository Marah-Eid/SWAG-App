...
const ChattingScreenV = () => {
    ...
    const { userName = "User", userType = "customer", chatId, conversationId } = useLocalSearchParams();
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.headerInfo} onPress={handleProfilePress} activeOpacity={0.7}>
                    <Image source={require('../../../assets/images/user-icon.png')} style={styles.headerAvatar} />
                    <View>
            ...
            <ProfilePopupV visible={isProfileVisible} onClose={() => setProfileVisible(false)} userName={userName} carName="Customer Account" profileImage={require('../../../assets/images/user-icon.png')} bannerImage={require('../../../assets/images/swag-pattern.png')} />
        </View>
    );
};
