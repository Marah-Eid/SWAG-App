...
const CommentsModalV = ({ visible, onClose, postId }) => {
    ...
    return (
        <View>
                                    ...
                                    <View style={styles.commentItem}>
                                        ...
                                        <View style={styles.textBubbleWrapper}>
                                            ...
                                            <View style={styles.bubbleHeader}>
                                                <TouchableOpacity onPress={() => handleUserPress(item)} activeOpacity={isMe ? 1 : 0.8}>
            ...
            {/* Profile Popup Overlay for viewing Customer Details */}
            <ProfilePopupV
...
const styles = StyleSheet.create({
    overlay: {
        flex: 1,
        backgroundColor: 'rgba(0,0,0,0.65)', // UI Polish: Cinematic depth
