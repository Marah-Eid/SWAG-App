...
const CategoryItem = ({ title, iconName, onPress }) => (
  <TouchableOpacity style={styles.item} onPress={onPress} activeOpacity={0.8}>
    {/* Upper Part: Icon Container using Ionicons */}
    <View style={styles.imageContainer}>
      <Ionicons name={iconName} size={28} color="#5B7896" />
    </View>
    {/* Lower Part: Brand Red Label */}
      ...
      >
        <View style={styles.itemsRow}>
          ...
          <CategoryItem
            ...
            onPress={() => router.push('/vendor/ServicesVen')}
          />
        </View>
      </LinearGradient>
    </View>
...
export default TopCategoryBarV;